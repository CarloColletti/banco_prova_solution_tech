@foreach ($products as $product)
    <div class="col-12 col-sm-6 col-md-4 col-lg-3 g-4 d-flex justify-content-center">
        <div class="card card-for-cart" data-id="{{ $product->id }}" id="product-{{ $product->id }}"
            style="width: 18rem;">
            ...
            <ul class="list-group list-group-flush">
                ...
                <input type="checkbox" name="products[]" value="{{ $product->id }}" class="form-check-input" default
                    hidden>
            </ul>
        </div>
    </div>
